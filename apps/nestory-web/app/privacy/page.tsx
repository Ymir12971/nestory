  ...
  return (
    <main style={pageStyle}>
      ...
      <ul style={ulStyle}>
        ...
        <li><strong>Anthropic</strong> — generates the AI Story from your moment text and metadata (no human review of inputs; outputs are stored in our database).</li>
      ...
      <p>
        You can review and edit your profile and moments at any time in the
      ...
      <p>
        Nestory is designed for parents and caregivers to record moments of
