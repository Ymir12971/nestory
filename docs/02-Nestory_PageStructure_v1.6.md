...
> ⚠️ **Tag 体系已于 2026-08-09 整体废弃。**
>
> 本文中所有关于 Tag / Tag Picker / `user_tag_library` / `tag_values` / `raw_assets.tags` 的
> 内容均已作废。代码、接口、数据库、storyGen prompt 输入均已删除（迁移 `20260809220000_remove_tags`）。
> 现状以 [`new-version-2026-07-14/figma-calibration-2026-08-05.md`](new-version-2026-07-14/figma-calibration-2026-08-05.md) 的
> 「Tag 体系整体下线」一节为准。
> 
